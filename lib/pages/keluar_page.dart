          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.trolley, color: Colors.white, size: 35),
                    SizedBox(width: 10),
                    Text(
                      'Barang Keluar',
                      style: TextStyle(
                ...
                SizedBox(height: 8),
                Text(
                  'Total: ${barangKeluarList.length} item',
                  style: TextStyle(
                    fontSize: 14,
            ...
            child: loading
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final item = barangKeluarList[index];
